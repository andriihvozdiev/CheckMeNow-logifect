...
const VaccinationAppointment = (props) => {
    ...
    const setAppointmentDateHandler = () => {
        ...
        if (hour < 8 || hour >= 20) {
            ...
            props.navigation.push('HaveBooked');
        }
    }
        ...
        <View style={styles.container}>
            ...
            <View style={{ marginTop: '15%' }}>
                <Text style={{ ...styles.defaultText, marginBottom: '5%' }}>
                    Please select the available date and time for first
...
export default withReduxStore(VaccinationAppointment);
